...
public class Maze {
    ...
    public void init() {
        ...
        //Wall Types
        Square Horizonsq = new Square();
        Horizonsq.dot = false;
        Horizonsq.wall = WallType.HORIZONTAL;
        Square Virticsq = new Square();
        Virticsq.dot = false;
        Virticsq.wall = WallType.VERTICAL;
        ...
        //Pixels X and Y
            ...
            //         }
            //     }
        // grid[0][0].pixelX = 0*sqSize + sqSize/2;
        // grid[0][0].pixelY = 0*sqSize + sqSize/2;
    }
    ...
    public enum WallType {
        ...
        NONE, HORIZONTAL, VERTICAL, TRC, TLC, BRC, BLC, VET, VEB, HEL, HER
    }
            ...
            for (int row = 0; row < nRows; row++) {
                for (int col = 0; col < nCols; col++) {
                    ...
                    // require some simple math to figure out.
                        ...
                        //     System.out.println("pixelY: " + pixelX);
